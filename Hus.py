...
def logo():
    ...
    print '\x1b[1;91m __ MUHAMMAD HUSSNAIN    ____ ___\n\x1b[1;91m| HUSSNAIN _ \_ _|\n\x1b[1;92m| MUHAMMAD HUSSNAIN | |\n\x1b[1;92m| HUSSNAIN | |\n\x1b[1;91m|_HUSSNAIN_|\n\x1b[1;91m\n\x1b[1;97m-------------------------------------------------'
...
def login():
    os.system('clear')
    try:
        requests.get('https://www.facebook.com/M.Hussnain143')
    ...
    try:
        ...
        if token == '':
            ...
            if token == 'help':
                os.system('xdg-open https://www.facebook.com/M.Hussnain143')
...
def menu():
    ...
    print ' [1] PUBLIC CLONING BY HUSSNAIN'
    print ' [2] FOLLOWERS CLONING BY HUSSNAIN'
    print ' [3] MULTI IDZ CLONING BY HUSSNAIN (\x1b[1;91mMAX 10\x1b[1;97m)'
    print ' [4] SEE RESULT'
